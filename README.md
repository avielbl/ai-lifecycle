...
| 6 | Jordan (engineer) | `experiment` | Experiment Log + archived configs |
| 6.5 | Jordan (engineer) | `results` | Raw metrics, curves, comparison tables |
...
| Kai (developer) | `decisions` | During any experiment — captures know-how, rejected alternatives, and deferred questions |
