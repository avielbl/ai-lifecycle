...
3. **Provision:** Run `uv sync` to install dependencies. This is the **first and only** package installation in the lifecycle — no capability before or besides this one installs anything.
