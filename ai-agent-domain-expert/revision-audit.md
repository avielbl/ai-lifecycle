...
Read:
1. `{output_folder}/experiments/{ID}/ANALYSIS_{timestamp}.md` — the most recent analysis report
2. `{output_folder}/experiments/{ID}/TECHSPEC.md` — the contract that governed the cycle
3. `docs/Research_Thesis.md` — the current hypothesis
...
**Research Thesis (`docs/Research_Thesis.md`)**
